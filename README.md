...
<div align="left" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #121212; color: #ffffff; padding: 20px; border-radius: 10px;">
...
<h2 style="color: #0080c0;">⚙️ Como Executar e Testar</h2>
  <ol>
    <li>Clone o repositório: <code>git clone [URL]</code></li>
    <li>Configuração: [Descrever passos de env ou banco de dados]</li>
    <li>Execução: <code>./mvnw spring-boot:run</code></li>
  </ol>
...
<h2 style="color: #0080c0;">👥 Equipe</h2>  <table>
    <tr>
      <th>Membro</th>
      <th>Função</th>
      <th>Github</th>
